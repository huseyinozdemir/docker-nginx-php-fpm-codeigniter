...
RUN apt-get update \
    ...
    php7.0-fpm php-memcache php-memcached \
    php7.0-mysql php7.0-curl php7.0-mbstring
...
sed -i -e "s/listen = \/run\/php\/php7.0-fpm.sock/listen = 127.0.0.1:9001/g" /etc/php/7.0/fpm/pool.d/www.conf
